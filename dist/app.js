...
const walletControllers_1 = require("../src/controllers/walletControllers");
...
const walletController = new walletControllers_1.WalletController(walletService);
const karmaService = new karmaService_1.KarmaService();
const userService = new userService_1.UserService(db, karmaService, walletService);
